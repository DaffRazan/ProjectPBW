...
<head>
    ...
    <style>
        ...
        align-items: center;
        padding: 15px;
        background: url('https://images.pexels.com/photos/1345190/pexels-photo-1345190.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') center;
        -webkit-background-size: cover;
        -moz-background-size: cover;
        -o-background-size: cover;
        background-size: cover;
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/material-kit.css?v=2.0.4'); ?>">                
    ...
    <nav class="navbar navbar-expand-lg navbar-fixed-top " style="font-family: montserrat; font-size: 16px; font-weight:300; background-color:none;" >
        <a href="<?= base_url('user'); ?>"> <img style="width:auto; height:70px; position:relative;" class="img-fluid ml-5" src="<?= base_url('assets/img/logo/logoNya.png'); ?>" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                <a class="nav-item nav-link mr-4" style="color: #221c10; font-weight:500;" onMouseOver="this.style.color='#ffac06'" onMouseOut="this.style.color='#221c10'" href="<?= base_url('user/order'); ?>"><i class="fas fa-shopping-basket"></i> Order</a>
                <a class="nav-item nav-link mr-4" style="color: #221c10; font-weight:500;" onMouseOver="this.style.color='#ffac06'" onMouseOut="this.style.color='#221c10'" href="<?= base_url('user/profile'); ?>"><i class="fas fa-user"></i> Profile</a>
