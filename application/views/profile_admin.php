            ...
            <div class="card text-white mb-3 mx-auto mt-5" style="max-width: 30rem; background-color:#3e2516; border-radius:20px; width: 30rem;">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-xl-12">
                            <a class="btn btn-success" href="<?= base_url('admin/editProfile'); ?>">Edit Profile</a>
                        </div>
                        <div class="col-xl-12 mt-3 ">
                            <a class="btn btn-danger" href="<?= base_url('admin/changePassword'); ?>">Change Password</a>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <h5 class="card-title text-warning">Id Admin: <?= $user['id']; ?></h5>
                    ...
                    <p class="card-text text-white mt-3 float-right">Admin since <?= date('d F Y', $user['date_created']); ?></p>
                </div>
            </div>
        </div>
